# field-expedition-ledger__011 Docker 交付说明
...
```bash
./build_benzhi_docker.sh field-expedition-ledger__011-benzhi linux/amd64
docker run --rm -it field-expedition-ledger__011-benzhi bash
```
